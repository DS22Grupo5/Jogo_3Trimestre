...
public class PlayerController : MonoBehaviour
{
    ...
    public AudioSource audioPulo;           //máscara de camada do chão
    public bool onGround;    
    public int vidas;    
    public Sprite spriteCoracaoVazio;               //variável que identifica se jogador está no chão ou não
    ...
    private GameObject telaGameOver;                  //armazena collider do jogador
    ...
    void Start()
    {
        ...
        audioPulo = GameObject.Find("Player").GetComponent<AudioSource>();
        telaGameOver.SetActive(false);   //referencia o collider do jogador na variável
        vidas = 5;
    }
    ...
    void Update()
    {
        ...
        switch (vidas)
        {
            ...
            case 0:
                ...
                Invoke("RecarregarCena", 2f);   //referencia o collider do jogador na variável
    ...
    void ClimbLadder()
    {
        ...
        if (Input.GetKey(KeyCode.W) && TouchingLadder()) //se o input da vertical for pressionado e o jogador esiver se colidindo com escada
        {
    ...
    void CheckInputs()
    {
        ...
        jumpPressed = jumpPressed || Input.GetKey(KeyCode.UpArrow);
