...
public class PersonagemAtirarFase3 : MonoBehaviour
{
    ...
    {
        isShooting = false;
        animPersonagem = GameObject.Find("Player").GetComponent<Animator>();
        alterarSpriteHUD = GameObject.Find("barraMunicao").GetComponent<SpriteRenderer>();
        audioTiro = GameObject.Find("escada").GetComponent<AudioSource>();
    ...
    IEnumerator Shoot()
    {
        ...
        direcao = 1;
        direcao = GameObject.Find("Player").GetComponent<PlayerController>().direction;
